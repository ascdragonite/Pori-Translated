...
namespace Dialog_Ripper
{
    public class DialogRipperMain : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            Universe.Init();
            LoggerInstance.Msg("Dialog Ripper Activated");
        ...
        public void GenerateDict(string Database)
        {
            ...
            LoggerInstance.Msg("Reading from existing DialogList");
        }
